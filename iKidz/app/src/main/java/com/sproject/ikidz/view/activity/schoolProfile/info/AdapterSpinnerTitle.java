...
import com.sproject.ikidz.model.entity.UpToClassEntity;
 ...
 */
public class AdapterSpinnerTitle extends BaseAdapter {

    List<String> StringList;
    Context context;

    public AdapterSpinnerTitle(Context context, List<String> StringList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_menu.setText(StringList.get(position));
        return view;
    }
