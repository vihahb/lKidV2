...
public class SharedUtils {
    ...
    private SharedUtils() {
        sharedPreferences = iKidApplications.context.getSharedPreferences(Constants.SHARED_NAME, Context.MODE_PRIVATE);
    }
    ...
    public boolean getBooleanValue(String name, boolean defaultVal) {
