...
public abstract class UpdateAttendanceIn extends AbsICmd {
    BasicModel basicModel = new BasicModel();
    DataUpdateAttendance data;

    public UpdateAttendanceIn(DataUpdateAttendance data) {
        this.data = data;
        run();
    }
    ...
    protected void invoke() {
        ...
        String url = link_api + "attendance";
        ...
        basicModel.requestServer.postApi(url, JsonHelper.toJson(data), token, new ResponseHandle<RESP_Status>(RESP_Status.class) {
            ...
            protected void onSuccess(RESP_Status obj) {
                UpdateAttendanceIn.this.onSucces(obj);
            }

            @Override
            protected void onError(ErrorEntity error) {
                UpdateAttendanceIn.this.onError(error);
            }
        });
    }
