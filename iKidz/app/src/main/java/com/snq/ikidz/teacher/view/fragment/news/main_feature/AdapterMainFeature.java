package com.snq.ikidz.teacher.view.fragment.news.main_feature;
...
import com.snq.ikidz.teacher.model.entity.viewObject.Feature;
import com.snq.ikidz.teacher.sdk.Utils.TextUtils;
import com.snq.ikidz.teacher.view.activity.absent.AbsentsActivity;
import com.snq.ikidz.teacher.view.activity.attendance.in.AttendanceInActivity;
import com.snq.ikidz.teacher.view.activity.attendance.outs.AttendanceOutActivity;
import com.snq.ikidz.teacher.view.activity.drug.teacher.DrugActivity;
import com.snq.ikidz.teacher.view.activity.learnOverTime.LearnOverTimeActivity;
...
public class AdapterMainFeature extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Feature feature, int position) {
            if (featureList.get(position).isShowFull())
            {
