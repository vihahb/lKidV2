...
import com.snq.ikidz.teacher.model.entity.SchoolByDistrict
import com.snq.ikidz.teacher.presenter.Login.LoginPresenter
import com.snq.ikidz.teacher.sdk.Commons.Constants
import com.snq.ikidz.teacher.sdk.Utils.Base64Helper
...
class LoginActivity : BaseActivity(), ILogin {
    ...
    override fun onLoginSuccess(login: RESP_Login) {
        if (login.data.user.roles.slug == Constants.TEACHER){
            ...
            showLongToast("Vui lòng sử dụng tài khoản dành cho giáo viên!")
            return
        }
